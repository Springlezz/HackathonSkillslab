...
$command_480 = "ffmpeg -i $inputFile -vf scale=854:480 -c:a aac -strict experimental $outputFile1";
$command_720 = "ffmpeg -i $inputFile -vf scale=1280:720 -c:a aac -strict experimental $outputFile2";
$command_1080 = "ffmpeg -i $inputFile -vf scale=1920:1080 -c:a aac -strict experimental $outputFile3";
$command_4000 = "ffmpeg -i $inputFile -vf scale=3840:2160 -c:a aac -strict experimental $outputFile4";
